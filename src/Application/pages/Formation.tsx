...
const Formation = () => {
  const formationsList = [
    { url: "https://www.insa-toulouse.fr/formation/ingenieur-specialite-informatique-et-reseaux/", imageSrc: insa, annee: "INSA Toulouse - 2027", diplome: "Ingénieur Informatique et Réseaux", description : "Préorientation 3° année 'Modélisation, Informatique et Communication'", mention: "En cours d'obtention"},
